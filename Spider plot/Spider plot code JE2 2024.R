...
spider_file <- file.path(output_folder, "KEGG_category_matrix_significant_JE2_2024.xlsx")

# ----------------------------
# 2) Einlesen und Spalten entfernen (wie zuvor)
# ----------------------------
...
rad <- ggradar(
  ...
  labs(title = "Spider Chart – Staphylococcus aureus JE2 (2024)") +  
  theme_minimal() +
  theme(
...
# ----------------------------
# Pfad zur SVG-Datei
svg_file <- file.path(output_folder, "SpiderPlot_KEGG_JE2_2024.svg")
